...
def main():
    ...
    y_soft = 0.6 * y_soft_gamlp + 0.2 * y_soft_sagn + 0.2 * y_soft_sage + 0.2 * y_soft_gat
    ...
    # val_acc = torch.sum(y_pred_gat[val_nid] == labels[val_nid]) / torch.tensor(labels[val_nid].shape[0])
